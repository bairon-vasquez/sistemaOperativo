...
class Calculadora(QMainWindow):
    def __init__(self):
        ...
        self.setGeometry(100, 100, 400, 600)  # Ajusta el tamaño de la ventana
        ...
        # Crear la pantalla de la calculadora (QLineEdit)
        self.pantalla = QLineEdit()
        self.pantalla.setAlignment(Qt.AlignRight)
        self.pantalla.setReadOnly(True)
        self.pantalla.setFixedHeight(100)  # Aumentar el tamaño de la pantalla
        self.pantalla.setFont(QFont('Arial', 20))  # Aumentar el tamaño de la fuente
        layout.addWidget(self.pantalla)

        # Crear el layout de botones
        botones_layout = QGridLayout()

        # Definir botones con funciones científicas
        botones = [
            ('7', 0, 0), ('8', 0, 1), ('9', 0, 2), ('/', 0, 3),
            ('4', 1, 0), ('5', 1, 1), ('6', 1, 2), ('*', 1, 3),
            ('1', 2, 0), ('2', 2, 1), ('3', 2, 2), ('-', 2, 3),
            ('0', 3, 0), ('.', 3, 1), ('=', 3, 2), ('+', 3, 3),
            ('C', 4, 0), ('(', 4, 1), (')', 4, 2), ('^', 4, 3),  # ^ para exponenciación
            ('sin', 5, 0), ('cos', 5, 1), ('tan', 5, 2), ('log', 5, 3),
            ('sqrt', 6, 0), ('pi', 6, 1), ('e', 6, 2), ('!', 6, 3)  # sqrt para raíz cuadrada, pi, e, factorial
        ]

        # Crear y agregar los botones al layout
        for texto, fila, columna in botones:
            boton = QPushButton(texto)
            boton.setFont(QFont('Arial', 10))  # Aumentar el tamaño de la fuente de los botones
            boton.setFixedSize(60, 60)  # Aumentar el tamaño de los botones
    ...
    def keyPressEvent(self, event):
        ...
        # Detectar teclas de números y operadores
        if key == Qt.Key_0:
            self.on_click('0')
        elif key == Qt.Key_1:
            self.on_click('1')
...
# Para ejecutar la calculadora independientemente, puedes hacer esto:
